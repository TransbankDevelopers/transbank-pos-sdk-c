...
char *list_ports() {
    ...
    if (retval == SP_OK) {
        ...
        /*
         * Se utiliza calloc en lugar de malloc para asegurarse que el 
         * area de memoria reservada este con sus bytes a 0, de esta 
         * forma en caso de que no existan puertos seriales no se retorne 
         * un listado falso.
         */
        portList = calloc((separators) + chars, sizeof (char *));

...
dlljava:
	...
	cd build && cc -fpic -c ../src/transbank.c ../wrapper/transbank_wrap.c ../src/transbank_serial_utils.c -I../src -I../include -IC:/jdk1.8.0_251/include -IC:/jdk1.8.0_251/include/win32
	cc -shared build/transbank.o build/transbank_wrap.o build/transbank_serial_utils.o build/version.o -o build/TransbankWrap.dll -lserialport -Wl,--subsystem,windows -I../include -L.
	copy build\TransbankWrap.dll d:\dll\
